...
<div class="maintenance wfull hfull">
	<div class="bg333 h50 text-center cwhite pt15">
		<span class="fontproximabold caps">Maintenance mode</span>
	</div>
	<div class="bgmiddle maintenance">
		<div class="bgmainop90 h80 titlefont cwhite size16 text-center pt20">
			<span class="fontproximabold">The website is undergoing some scheduled maintenance.</span><br/>
			Please come back later.
		</div>
		<div class="bgmainop90 h200 percent50 titlefont cwhite size16 valign none">
			<div class="valign plr50">
				<span class="fontproximabold">The website is undergoing some scheduled maintenance.</span><br/>
				Please come back later.
			</div>
		</div>
	</div>
	<div class="bgwhite bottom wfull h80 pt30 plr30">
		<div class="pull-left">
			<span class="bold c999">© 2015. TitanicThemes. All rights reserved.</span></div>
