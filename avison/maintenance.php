...
<div class="maintenance wfull hfull">
	<div class="bg333 h50 text-center cwhite pt15 none">
		<span class="fontproximabold caps">Maintenance mode</span>
	</div>
	<div class="bgmiddle2 ">
		<div class="bgmainop90 h200 percent50 titlefont cwhite size16 valign">
			<div class="valign plr50">
				<span class="fontproximabold caps">Maintenance mode</span><br/>
				The website is undergoing some scheduled maintenance.<br/>
				Please come back later.
			</div>
		</div>
	</div>
	<div class="bottom wfull h100 pt30 plr30 text-center">
		<div class="">
			<span class="bold cwhite size12">© 2015. TitanicThemes. All rights reserved.</span></div>
		<div class="pt10">
