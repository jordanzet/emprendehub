...
<header id="navoffset" class="megadrop">
	<div class="cd-dropdown-wrapper">
		<a class="cd-dropdown-trigger titlefont size20" href="#"><span class="ti-menu"></span></a>
					...
					<ul class="cd-dropdown-gallery is-hidden">
						...
						<li>
							<a class="cd-dropdown-item" href="#">
								<img src="images/tm22/img-women.jpg" alt="Product Image">
								<h3>Women</h3>
							</a>
						</li>
						...
						<li>
							<a class="cd-dropdown-item" href="#">
								<img src="images/tm22/img-men.jpg" alt="Product Image">
								<h3>Men</h3>
							</a>
						</li>
						...
						<li>
							<a class="cd-dropdown-item" href="#">
								<img src="images/tm22/img-boys.jpg" alt="Product Image">
								<h3>Boys</h3>
							</a>
						</li>
						...
						<li>
							<a class="cd-dropdown-item" href="#">
								<img src="images/tm22/img-girls.jpg" alt="Product Image">
								<h3>Girls</h3>
							</a>
						</li>
	...
	<span class="mdlogo fontproximabold"><a href="index.php"><span class="cdark">avision</span></a></span>
	<a href="#" class="mdbag"><span class="ti-bag size30"></span></a>
</header>
...
<main class="cd-main-content">
			...
			<ul>
				...
				<li data-transition="fade" data-slotamount="1" data-masterspeed="1000" data-color="white">
					...
					<div class="prlx-on tp-caption fontproximaextrabold size50 cwhite customin customout"
						...
						style="z-index: 4">Mega Dropdown Shop Menu
					</div>
					...
					<div class="prlx-on tp-caption fontproximalight size30 cwhite customin customout"
						...
						data-captionhidden="on"
						style="z-index: 10">If you are looking for an online store, you will love this menu 
					</div>
					...
					<div class="prlx-on tp-caption customin customout"
						...
						data-endeasing="Back.easeIn"
						data-captionhidden="on"
						style="z-index: 10"><button type="submit" class="btn btnwhiteline2 fontproximabold plr50 caps center triggerMegaDrop">Try it now</button>
					</div>
	...
	<div class="h350 bgwhite relative z10 opacitymd">

		<div class="container-full hfull ">
...
<div id="navoffset2" class="h50 bg111 text-center">
	<p class="pt15 caps cgrey size12">&copy; TitanicThemes.com | All rights reserved.</p>
</div>

<div class="sidecart2">
	<span class="shaddow text-center">
		<a href="#" class="closecart2 pt40 block"><span class="ti-close size24 cdark"></span></a>
	</span>
	<div class="p50">
		<h3>shopping bag</h3>
...
<script type="text/javascript" src="js/page22.js"></script>
